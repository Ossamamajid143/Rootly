    ...
    <section className="relative isolate overflow-hidden bg-brand-dark py-20 text-white sm:py-28">
      ...
      <Container className="relative">
        <ScrollReveal className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-base leading-8 text-white/72">Explore ROOTLY's focused collection of plant powders and blends, delivered to your door worldwide.</p>
