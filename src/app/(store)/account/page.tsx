    ...
    <main>
      ...
      <Container className="py-12 sm:py-20">
        <div className="mx-auto max-w-2xl rounded-[2.5rem] border border-border bg-surface p-8 text-center shadow-[var(--shadow-soft)] sm:p-12">
          ...
          <Link href="/contact" className="mt-8 inline-flex min-h-12 items-center rounded-full bg-forest px-7 text-sm font-bold text-white transition hover:bg-brand">Get order support</Link>
        </div>
      </Container>
    </main>
  );
